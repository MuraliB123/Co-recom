...
def search():
    temp_data = pd.read_csv("/home/murali/Documents/Co-recom/dataset1.csv")
    data = pd.read_csv("/home/murali/Documents/Co-recom/dataset2.csv")
    label_encoders = {}
    ...
    return jsonify({'courses': final_recom})
...
def display():
    dataset = pd.read_csv("/home/murali/Documents/Co-recom/f_dataset(1).csv")
...
@app.route('/item')
def show():
    data = pd.read_csv("/home/murali/Documents/Co-recom/f_dataset(1).csv")
    index_to_course = {}
    course_to_index = {}
